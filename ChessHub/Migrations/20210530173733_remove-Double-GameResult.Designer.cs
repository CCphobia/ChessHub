...
namespace ChessHub.Migrations
{
    ...
    [Migration("20210530173733_remove-Double-GameResult")]
    partial class removeDoubleGameResult
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChessHub.Entities.Game", b =>
                {
            ...
            modelBuilder.Entity("ChessHub.Entities.Game", b =>
                {
                    b.HasOne("ChessHub.Entities.User", "BlackPlayer")
                        .WithMany("BlackGames")
                    ...
                    b.HasOne("ChessHub.Entities.User", "WhitePlayer")
                        .WithMany("WhiteGames")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ChessHub.Entities.User", null)
                        .WithMany()
