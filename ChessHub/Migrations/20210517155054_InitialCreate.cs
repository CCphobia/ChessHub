            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GameId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    GameResultId = table.Column<int>(type: "int", nullable: false),
                    MovesCounter = table.Column<int>(type: "int", nullable: false),
                    Moves = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    WhitePlayerId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    BlackPlayerId = table.Column<string>(type: "nvarchar(450)", nullable: true),
